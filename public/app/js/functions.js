...
var e = {
    ...
    darkMode: function () {
        ...
        var changeThemeToDark = () => {
            ...
            if (dir == 'rtl') {
                style.setAttribute('href', '/app/css/style-dark-rtl.html');
            } else {
                style.setAttribute('href', '/app/css/style-dark.css');
            }
        ...
        var changeThemeToLight = () => {
            ...
            if (dir == 'rtl') {
                style.setAttribute('href', '/app/css/style-rtl.html');
            } else {
                style.setAttribute('href', '/app/css/style.css');
            }
    ...
    avatarImg: function () {
        if (e.isVariableDefined(e.select('#avatarUpload'))) {
            ...
            avtReset.addEventListener("click", function () {
                avtPreview.src = "/app/images/avatar/placeholder.jpg";
            });
        }
    },
    // END: Avatar Image
