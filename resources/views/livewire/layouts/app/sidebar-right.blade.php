        ...
        <div class="col-sm-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-header pb-0 border-0">
                    <h5 class="card-title mb-0">Latest Event</h5>
                </div>
                <!-- Card header END -->
                <!-- Card body START -->
                <div class="card-body">
                    ...
                    <div class="hstack gap-2 mb-3">
                        <!-- Avatar -->
                        <div class="avatar">
                            <a href="#!"><img class="avatar-img rounded-circle" src="/app/images/avatar/04.jpg"
                                    alt=""></a>
                        </div>
                        <!-- Title -->
                    ...
                    <div class="hstack gap-2 mb-3">
                        ...
                        <div class="avatar avatar-story">
                            <a href="#!"> <img class="avatar-img rounded-circle" src="/app/images/avatar/05.jpg"
                                    alt=""> </a>
                        </div>
                        <!-- Title -->
                        <div class="overflow-hidden">
                    ...
                    <div class="hstack gap-2 mb-3">
                        <!-- Avatar -->
                        <div class="avatar">
                            <a href="#"> <img class="avatar-img rounded-circle" src="/app/images/avatar/11.jpg"
                                    alt=""> </a>
                        </div>
                        <!-- Title -->
                        <div class="overflow-hidden">
                    ...
                    <div class="hstack gap-2 mb-3">
                        <!-- Avatar -->
                        <div class="avatar">
                            <a href="#"> <img class="avatar-img rounded-circle" src="/app/images/avatar/01.jpg"
                                    alt=""> </a>
                        </div>
                        <!-- Title -->
                        <div class="overflow-hidden">
                    ...
                    <div class="hstack gap-2 mb-3">
                        ...
                        <div class="avatar">
                            <a href="#"> <img class="avatar-img rounded-circle"
                                    src="/app/images/avatar/placeholder.jpg" alt=""> </a>
                        </div>
                        <!-- Title -->
                        <div class="overflow-hidden">
